...
<html lang="en">
<head>
    <title>Code coverage report for hoc.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> hoc.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
      public async componentDidMount () {
        try {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.hasBeenCancelled) this.setState({ isLoading: false })
        } catch (error) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.hasBeenCancelled) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >      public componentWillUnmount () {</span>
<span class="cstat-no" title="statement not covered" >        this.hasBeenCancelled = true</span>
      }
&nbsp;
      public render () {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Nov 16 2018 13:28:10 GMT-0800 (Pacific Standard Time)
</div>
</div>
