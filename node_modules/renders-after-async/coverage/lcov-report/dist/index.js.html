...
var __extends = <span class="cstat-no" title="statement not covered" >(this &amp;&amp; this.__extends) || (<span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
    var extendStatics = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction (d, b) {</span>
<span class="cstat-no" title="statement not covered" >        extendStatics = Object.setPrototypeOf ||</span>
            ({ __proto__: [] } instanceof Array &amp;&amp; <span class="fstat-no" title="function not covered" >fu</span>nction (d, b) { <span class="cstat-no" title="statement not covered" >d.__proto__ = b; </span>}) ||
<span class="fstat-no" title="function not covered" >            fu</span>nction (d, b) { <span class="cstat-no" title="statement not covered" >for (var p in b) <span class="cstat-no" title="statement not covered" >if (b.hasOwnProperty(p)) <span class="cstat-no" title="statement not covered" >d[p] = b[p]; </span></span></span>};
<span class="cstat-no" title="statement not covered" >        return extendStatics(d, b);</span>
    }
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >fu</span>nction (d, b) {</span>
<span class="cstat-no" title="statement not covered" >        extendStatics(d, b);</span>
        function <span class="fstat-no" title="function not covered" >__(</span>) { <span class="cstat-no" title="statement not covered" >this.constructor = d; </span>}
<span class="cstat-no" title="statement not covered" >        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());</span>
    };
})();
var __assign = <span class="cstat-no" title="statement not covered" >(this &amp;&amp; this.__assign) || <span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
<span class="cstat-no" title="statement not covered" >    __assign = Object.assign || <span class="fstat-no" title="function not covered" >fu</span>nction(t) {</span>
...
<span class="cstat-no" title="statement not covered" >    return __assign.apply(this, arguments);</span>
};
...
<span class="cstat-no" title="statement not covered" >    return new (P || (P = Promise))(<span class="fstat-no" title="function not covered" >fu</span>nction (resolve, reject) {</span>
        ...
        function <span class="fstat-no" title="function not covered" >step(</span>result) { <span class="cstat-no" title="statement not covered" >result.done ? resolve(result.value) : new P(<span class="fstat-no" title="function not covered" >fu</span>nction (resolve) { <span class="cstat-no" title="statement not covered" >resolve(result.value); </span>}).then(fulfilled, rejected); </span>}
...
var __importStar = <span class="cstat-no" title="statement not covered" >(this &amp;&amp; this.__importStar) || <span class="fstat-no" title="function not covered" >fu</span>nction (mod) {</span>
<span class="cstat-no" title="statement not covered" >    if (mod &amp;&amp; mod.__esModule) <span class="cstat-no" title="statement not covered" >return mod;</span></span>
    var result = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >    if (mod != null) <span class="cstat-no" title="statement not covered" >for (var k in mod) <span class="cstat-no" title="statement not covered" >if (Object.hasOwnProperty.call(mod, k)) <span class="cstat-no" title="statement not covered" >result[k] = mod[k];</span></span></span></span>
<span class="cstat-no" title="statement not covered" >    result["default"] = mod;</span>
<span class="cstat-no" title="statement not covered" >    return result;</span>
};
<span class="cstat-no" title="statement not covered" >Object.defineProperty(exports, "__esModule", { value: true });</span>
var React = <span class="cstat-no" title="statement not covered" >__importStar(require("react"));</span>
<span class="cstat-no" title="statement not covered" >exports.rendersAfterAsync = <span class="fstat-no" title="function not covered" >fu</span>nction (performAsync, LoadingComponent, ErrorComponent) {</span>
<span class="cstat-no" title="statement not covered" >    if (LoadingComponent === void 0) { <span class="cstat-no" title="statement not covered" >LoadingComponent = null; </span>}</span>
<span class="cstat-no" title="statement not covered" >    if (ErrorComponent === void 0) { <span class="cstat-no" title="statement not covered" >ErrorComponent = null; </span>}</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >fu</span>nction (Component) {</span>
<span class="cstat-no" title="statement not covered" >        return /** @class */ (<span class="fstat-no" title="function not covered" >fu</span>nction (_super) {</span>
<span class="cstat-no" title="statement not covered" >            __extends(Wrapper, _super);</span>
            function <span class="fstat-no" title="function not covered" >Wrapper(</span>) {
                var _this = <span class="cstat-no" title="statement not covered" >_super !== null &amp;&amp; _super.apply(this, arguments) || this;</span>
...
<span class="cstat-no" title="statement not covered" >            Wrapper.prototype.componentDidMount = <span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
<span class="cstat-no" title="statement not covered" >                return __awaiter(this, void 0, void 0, <span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
                    var error_1;
<span class="cstat-no" title="statement not covered" >                    return __generator(this, <span class="fstat-no" title="function not covered" >fu</span>nction (_a) {</span>
<span class="cstat-no" title="statement not covered" >                        switch (_a.label) {</span>
                            case 0:
<span class="cstat-no" title="statement not covered" >                                _a.trys.push([0, 2, , 3]);</span>
<span class="cstat-no" title="statement not covered" >                                return [4 /*yield*/, performAsync(this.props)];</span>
                            case 1:
<span class="cstat-no" title="statement not covered" >                                _a.sent();</span>
<span class="cstat-no" title="statement not covered" >                                this.setState({ isLoading: false });</span>
<span class="cstat-no" title="statement not covered" >                                return [3 /*break*/, 3];</span>
                            case 2:
<span class="cstat-no" title="statement not covered" >                                error_1 = _a.sent();</span>
<span class="cstat-no" title="statement not covered" >                                this.setState({ error: error_1, isLoading: false });</span>
<span class="cstat-no" title="statement not covered" >                                throw error_1;</span>
                            case 3: <span class="cstat-no" title="statement not covered" >return [2 /*return*/];</span>
                        }
                    });
                });
            };
<span class="cstat-no" title="statement not covered" >            Wrapper.prototype.render = <span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
                var _a = <span class="cstat-no" title="statement not covered" >this.state,</span> error = <span class="cstat-no" title="statement not covered" >_a.error,</span> isLoading = <span class="cstat-no" title="statement not covered" >_a.isLoading;</span>
<span class="cstat-no" title="statement not covered" >                if (isLoading)</span>
<span class="cstat-no" title="statement not covered" >                    return LoadingComponent ? React.createElement(LoadingComponent, null) : null;</span>
<span class="cstat-no" title="statement not covered" >                if (error)</span>
<span class="cstat-no" title="statement not covered" >                    return ErrorComponent ? React.createElement(ErrorComponent, null) : null;</span>
<span class="cstat-no" title="statement not covered" >                return React.createElement(Component, __assign({}, this.props));</span>
            };
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Aug 01 2018 05:24:12 GMT-0700 (PDT)
</div>
</div>
