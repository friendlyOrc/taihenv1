...
<html lang="en">
<head>
    <title>Code coverage report for render-props.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> render-props.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
  public async componentDidMount () {
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.hasBeenCancelled) this.setState({ error, isLoading: false })
    }
  }
&nbsp;
